...
The repository also ships an installable agent skill (`skills/freecad-mcp/`) that teaches the 23-tool contract, and a native-contract probe (`examples/native_contract_probe.py`) that records live FreeCAD behavior into `tests/native_contract.json`.
