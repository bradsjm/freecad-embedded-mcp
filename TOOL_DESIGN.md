...
- **No GUI emulation.** No selection events, no viewport control beyond `capture_view`, no dialog automation. The model's "eyes" are inspection results and one PNG with an explicit orientation.
