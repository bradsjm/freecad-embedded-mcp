...
| `edit_parameters` | Add, rename, bind expressions on, and clear expressions from dynamic properties with full validation and rollback. Native dotted targets such as `Placement.Base.y` are supported when their root property exists. |
